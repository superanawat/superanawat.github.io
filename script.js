...
analyzeBtn.addEventListener('click', () => {
  ...
  fetch(`${NGROK_URL}/analyze`, {
    ...
    .then((res) => res.json())
    .then((data) => {
      // ✅ ประกาศตัวแปรทั้งหมดไว้ภายในบล็อก .then() นี้เพื่อให้ใช้งานร่วมกันได้ถูกต้อง
      ...
      // ✅ แสดงผลในรูปแบบแนวนอน (แบ่ง 2 คอลัมน์ ซ้าย-ขวา) ภายใน scope นี้
      aiBox.innerHTML = `
        <div class="popup-horizontal-container" style="border-top: 1px solid #e2e8f0; padding-top: 10px; margin-top: 10px;">
          ...
          <div class="popup-col-left" style="flex: 1; min-width: 0;">
          ...
          <div class="popup-col-right" style="flex: 1; min-width: 0;">
